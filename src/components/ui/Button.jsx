...
const Button = ({ children, onClick, variant = 'primary', className = '', disabled, size = 'md', id, title }) => {
    const base = "font-extrabold tracking-wide transition-all duration-300 rounded-xl active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 select-none relative overflow-hidden group";
